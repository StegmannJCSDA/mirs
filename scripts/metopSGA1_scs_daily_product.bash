...
HDF5BIN=`grep HDF5BIN ../setup/paths | cut -f2 -d '=' | sed -e 's/^[ 	]*//'`
...
. ../setup/metopSGA1_pcf_daily_product.bash
...
if [[ "${step_nc}" -eq 1 ]] ; then
  mirs2nc_parallel ${edrDir} ${depDir} ${ncDir} ${binPath} ${satId} ${rdrSensor1List} ${rdrType} ${HDF5BIN} ${production_site} ${production_environment}
fi
