 ...
 * Junye Chen 12/20/2016 @ NOAA/NESDIS/STAR add JPSS/N20
 *
 */
...
public class Monitor extends JPanel
    ...
    /**
     * Use External SWE climatology in VIPP or not, 1 to use, 0 not use, default not to use  
     */
    private String sweClimoUse = "0";
    
    /**
     * Use External Forest Fraction in VIPP SWE or not, 1 to use, 0 not use, default not to use  
     */
    private String ffUse = "0";
     
    /**
     * Use External IMS Snow/Ice Analysis in NWP and/or 1DVAR or not, 1 to use, 0 not use, default not to use  
     */
    private String imsSfcUse = "0";
    ...
    private String mocString     = "MetOp-C/AMSUA/MHS";
    private String metopSGA1String = "MetOp-SGA1/MWS";
    private String f16String     = "F16/SSMIS";
    private String f18String     = "F18/SSMIS";
    private String f19String     = "F19/SSMIS";
    private String nppString     = "NPP/ATMS";
    private String n20String     = "NOAA-20/ATMS"; //Junye
    private String n21String     = "NOAA-21/ATMS"; //Junye
   ...
   //nOrbits2Process=50
     ...
     * N20 tasks
     */
    private String [] tasksKeysN20 = {	"rdr2tdrSensor1", 
 					"mergeNedt", 
					"tdr2sdrSensor1", 
    				"fm", 
					"ims4nwp",   //liusy+
     ...
     * metopSGA1 tasks
     */
    private String [] tasksKeysmetopSGA1 = {	"rdr2tdrSensor1", 
 					"mergeNedt", 
					"tdr2sdrSensor1", 
    				"fm", 
					"ims4nwp",   //liusy+
    ...
    */
    ...
    private String ims4nwpString 		         = new String("ims4nwp");
    ...
    private String ims4retrString 		         = new String("ims4retr");
    private String fmsdr2edrString 		         = new String("fmsdr2edr");
    private String mergeEdrString 		         = new String("mergeEdr");
    private String prepSweClimoString 		      = new String("prepSweClimo");
    private String ffCollocString 		         = new String("ffColloc");
    private String vippString 			         = new String("vipp");
    private String sfrString                    = new String("sfr");
	...
	+ "#                              (QSS/PSGS/DELL)\n"                                                                    
	+ "#        11/04/2016     v9      Junye Chen                Modified GUI to generate JPSS-1(N20)/ATMS enabled scripts.\n"
	...
	+ "HDF5BIN=`grep HDF5BIN "       + configPath + "paths | cut -f2 -d '=' | sed -e 's/^[ \t]*//'`\n"
   ...
   private String source2ScriptString
	...
	"	${fwdMatrix2Use} ${sweClimoUse} ${makeOrNot} ${useCPU}\n\n" );
	...
	"elif [[ ${satId} == \"f16\" || ${satId} == \"f17\" || ${satId} == \"f18\" || ${satId} == \"f19\" || ${satId} == \"fy3ri\" ]] ; then\n" +
	...
	"elif [[ ${satId} == \"n20\" ]] ; then\n" +
	"   SanityChecksOrbitProcess1 $1 ${rdrSensor1Path}\n" +
	"   orbitInfo=`ExtractRdrFileNamesfromOrbitN20 $1 ${rdrSensor1Path}`\n" +
	"elif [[ ${satId} == \"n21\" ]] ; then\n" +
	"   SanityChecksOrbitProcess1 $1 ${rdrSensor1Path}\n" +
	"   orbitInfo=`ExtractRdrFileNamesfromOrbitN21 $1 ${rdrSensor1Path}`\n" +
	"elif [[ ${satId} == \"metopSGA1\" ]] ; then\n" +
	"   SanityChecksOrbitProcess1 $1 ${rdrSensor1Path}\n" +
	"   orbitInfo=`ExtractRdrFileNamesfromOrbitmetopSGA1 $1 ${rdrSensor1Path}`\n" +
	"elif [[ ${satId} == \"trmm\" ]] ; then\n" +
	"   SanityChecksOrbitProcess1 $1 ${rdrSensor1Path}\n" +
	"   orbitInfo=`ExtractRdrFileNamesfromOrbitTrmm $1 ${rdrSensor1Path}`\n" +
	"elif [[ ${satId} == \"gpm\" ]] ; then\n" +
	"   SanityChecksOrbitProcess1 $1 ${rdrSensor1Path}\n" +
	"   orbitInfo=`ExtractRdrFileNamesfromOrbitGPM $1 ${rdrSensor1Path}`\n" +
	...
	"sfrDir=${sfrPath}/${rdirExt}\n" +
      	"gridDir=${gridPath}/${rdirExt}\n" +
      	"ncDir=${ncPath}/${rdirExt}\n" +
	"figsDir=${figsPath}/${rdirExt}\n" +
      	"regressRetrDir=${regressRetrPath}/${rdirExt}\n" +
      	"prepSweClimoDir=${prepSweClimoPath}/${rdirExt}\n" +
      	"ffCollocDir=${ffCollocPath}/${rdirExt}\n" +
      	"imsCollocDir=${imsCollocPath}/${rdirExt}\n" +
	...
	"prepSweClimoControlFile=${prepSweClimoControlFile}_${identifier}.in\n" +
	"ffCollocControlFile=${ffCollocControlFile}_${identifier}.in\n" +
	"imsCollocControlFile=${imsCollocControlFile}_${identifier}.in\n" +
	...
	"vippControlFile=${vippControlFile}_${identifier}.in\n" +
        ...
        "sfr2depControlFile=${sfr2depControlFile}_${identifier}.in\n" +
	...
	"fmsdr4PrepSweList=${fmsdr4PrepSweList}_${identifier}.list\n" +
	"fmsdr4ffCollocList=${fmsdr4ffCollocList}_${identifier}.list\n" +
	"fmsdr4SfrList=${fmsdr4SfrList}_${identifier}.list\n" +
   "fmsdr4imsCollocList=${fmsdr4imsCollocList}_${identifier}.list\n" + 
	"imsColloc4nwpList=${imsColloc4nwpList}_${identifier}.list\n" + 
	"imsColloc4retrList=${imsColloc4retrList}_${identifier}.list\n" + 
	"prepSweClimo4VippList=${prepSweClimo4VippList}_${identifier}.list\n" + 
	"ffColloc4VippList=${ffColloc4VippList}_${identifier}.list\n" + 
	...
	"sfrList=${sfrList}_${identifier}.list\n" +
	"gridNwpSfrList=${gridNwpSfrList}_${identifier}.list\n" +
	...
	"nedtExt=${fileExt}\n" +
	"if [[ ${satId} == \"f16\" || ${satId} == \"aqua\" || ${satId} == \"gcomw1\" || ${satId} == \"f17\" || ${satId} == \"f18\" || ${satId} == \"f19\" || ${satId} == \"fy3ri\" || ${satId} == \"trmm\" || ${satId} == \"gpm\" || ${satId} == \"mtma\" || ${satId} == \"mtsa\" ]] ; then\n" +
...
//jchen-	"if [[ ${satId} == \"npp\" ]]; then\n" +
	...
	"depGridStr=\"clw,gs,iwp,lwp,rr,rwp,sfc2,sice,sicefy,sicemy,snow,swe,tpw,sfr,sfrprob\"\n" +
	...
	"if [[ ${satId} == \"f16\" || ${satId} == \"f17\" || ${satId} == \"f18\" || ${satId} == \"f19\" || ${satId} == \"trmm\" || ${satId} == \"gpm\" || ${satId} == \"mtma\" || ${satId} == \"mtsa\" ]] ; then\n" +
	...
	"DirGen ${prepSweClimoDir} \"SWE Climatology\"\n" +
	"DirGen ${ffCollocDir} \"FF Collocation\"\n" +
	"DirGen ${imsCollocDir} \"IMS Collocation\"\n\n");
	...
	= new String(
        ...
        "#--------------------------------------------------------------------------------\n" +  //jchen+
        "#      N20/ATMS special case: to generate NEDT from SDR files\n" +  //jchen+
        "#--------------------------------------------------------------------------------\n" +  //jchen+
        "if [[ \"${step_rdr2tdrSensor1}\" -eq 1 && ${satId} == \"n20\" && ${rdrType} -eq 1 ]] ; then\n" +  //jchen+
          "  rdrType2=3\n" +  //jchen+
          "  nfile_gatmo=`ls -1 ${rdrSensor1Dir}/GATMO_j01* 2> /dev/null | wc -l`\n" +  //jchen+
          "  nfile_satms=`ls -1 ${rdrSensor1Dir}/SATMS_j01* 2> /dev/null | wc -l`\n" +  //jchen+
          "  #---- only do this when SDR files exist and have equal numer of GATMO files\n" +  //jchen+
          "  if [[ ${nfile_satms} -ge 1 && ${nfile_gatmo} -eq ${nfile_satms} ]] ; then\n" +  //jchen+
          "    rdr2tdr ${rdrSensor1Dir} ${rdrSensor1List} ${sensor1} ${tdrSensor1Dir} ${sensor1Nedt}\\\n" +  //jchen+
          "    ${instrumentSensor1File} ${sensor1Wt} ${nOrbits2Process} ${logFile}\\\n" +  //jchen+
        ...
        "#      N20/ATMS special case: to generate NEDT from SDR files\n" +  //jchen+
        "#--------------------------------------------------------------------------------\n" +  //jchen+
        "if [[ \"${step_rdr2tdrSensor1}\" -eq 1 && ${satId} == \"n21\" && ${rdrType} -eq 1 ]] ; then\n" +  //jchen+
          "  rdrType2=3\n" +  //jchen+
          "  nfile_gatmo=`ls -1 ${rdrSensor1Dir}/GATMO_j02* 2> /dev/null | wc -l`\n" +  //jchen+
          "  nfile_satms=`ls -1 ${rdrSensor1Dir}/SATMS_j02* 2> /dev/null | wc -l`\n" +  //jchen+
          "  #---- only do this when SDR files exist and have equal numer of GATMO files\n" +  //jchen+
          "  if [[ ${nfile_satms} -ge 1 && ${nfile_gatmo} -eq ${nfile_satms} ]] ; then\n" +  //jchen+
          "    rdr2tdr ${rdrSensor1Dir} ${rdrSensor1List} ${sensor1} ${tdrSensor1Dir} ${sensor1Nedt}\\\n" +  //jchen+
          "    ${instrumentSensor1File} ${sensor1Wt} ${nOrbits2Process} ${logFile}\\\n" +  //jchen+
    ...
    private String ims4nwpTaskString		    
    	= new String(
	"#--------------------------------------------------------------------------------\n" 	      +
	"#      step: Collocate FMSDRs with the IMS Snow/Ice surface type analysis (for nwp step)\n"  +
	"#--------------------------------------------------------------------------------\n" 	+
	"if [[ \"${step_ims4nwp}\" -eq 1 ]] ; then\n"                                           + 
   "   if [[ ${processMode} -eq 0 ]] ; then\n"                                             +
   "      yyyy=`echo ${orbitInfo} | cut -c1-4`\n"                                          +
   "      mm=`echo ${orbitInfo} | cut -c5-6`\n"                                            +
   "      dd=`echo ${orbitInfo} | cut -c7-8`\n"                                            +
   "      date=${yyyy}-${mm}-${dd}\n"                                                      +
   "   fi\n"                                                                               +
	"  yyyy=`echo ${date} | cut -c1-4`\n"                                                   +
	"  let ndays=${ndayLagIms}+1\n"                                                         +
	"  yyyymmdd=`date -d \"${date} $ndays days\" +%Y-%m-%d`\n"                              +
	"  yyyy=`echo ${yyyymmdd} | cut -c1-4`\n"                                               +
	"  jjj=`yyyymmdd2jjj $yyyymmdd`\n"                                                      +
	"  #imsFile=${imsAnalysisPath}/\"ims\"${yyyy}${jjj}\"_4km_v1.3.asc\"\n"                  +
   "  imsFile=${imsAnalysisPath}/\"NIC.IMS_v3_\"${yyyy}${jjj}\"00_4km.asc\"\n"             +
	"  echo \"imsFile=\" ${imsFile}\n"                                                      +
	"  if [ ! -e ${imsFile} ]; then\n"                                                      + 
	"     op_msg \"Warning in imsColloc: file not found\"\n"                                  +
	"     imsSfcUse=0\n"                                                                    +
	"  fi\n"                                                                                +
	"  if [ -e ${imsFile} ]; then\n"                                                      + 
        "     imsColloc ${fmsdrDir} \"${extResol}\" ${fmsdr4imsCollocList} ${imsCollocDir}"        + "\\\n" +
	"     ${imsFile} ${ndayLagIms} ${logFile} ${imsCollocControlFile}"                         + "\\\n" +
	"     ${imsCollocSrc} ${makeOrNot} ${binPath} ${processMode} ${orbitInfo}"                 + "\\\n" +
	"     ${retrOnOrbitOrSubOrbit} ${fmsdrChoppDir} ${sensorId}"                                        + "\\\n" +
	"     ${nOrbits2Process} ${version}\n"                                                     +
	"  fi\n"                                                                                +
	"fi\n\n" );
	...
	"  ${imsSfcUse} ${imsCollocDir} ${imsColloc4nwpList} ${processMode} ${orbitInfo}\n" +
	"fi\n\n" );
...
//liusy.
    ...
    private String ims4retrTaskString		    
    	= new String(
	"#--------------------------------------------------------------------------------\n" 	        +
	"#      step: Collocate FMSDRs with the IMS Snow/Ice surface type analysis (for 1dvar step)\n"  +
	"#--------------------------------------------------------------------------------\n" 	+
	"if [[ \"${step_ims4retr}\" -eq 1 ]] ; then\n"                                          + 
   "   if [[ ${processMode} -eq 0 ]] ; then\n"                                             +
   "      yyyy=`echo ${orbitInfo} | cut -c1-4`\n"                                          +
   "      mm=`echo ${orbitInfo} | cut -c5-6`\n"                                            +
   "      dd=`echo ${orbitInfo} | cut -c7-8`\n"                                            +
   ...
   "  ${applyRegressAlgSrc} ${makeOrNot} ${binPath} ${processMode} ${orbitInfo}"   	   + "\\\n" +
	...
	"  ${imsSfcUse} ${imsCollocDir} ${imsColloc4retrList}"                                 + "\\\n" + 
   ...
   "  ${TBbias_NNModelFile} ${TPW_NNModelFile} ${Tskin_NNModelFile} \n"                   + 
	"fi\n\n" );
   ...
   private String prepSweClimoTaskString		    
    	= new String(
    	"#--------------------------------------------------------------------------------\n" 	+
    	"#      step: Prepare files with SWE climatology information (for vipp)\n" 	      	+
    	"#--------------------------------------------------------------------------------\n" 	+
	"if [[ \"${step_prepSweClimo}\" -eq 1 ]] ; then\n" +
	"  prepSweClimo ${fmsdrDir} \"${extResol}\" ${fmsdr4PrepSweList} ${prepSweClimoDir}" 	+ "\\\n" + 
    	"  ${SweClimoMeanFile} ${SweClimoStdevFile} ${logFile} ${prepSweClimoControlFile}"     	+ "\\\n" +
	"  ${prepSweSrc} ${makeOrNot} ${binPath} ${processMode} ${orbitInfo}"     	        + "\\\n" +
	"  ${retrOnOrbitOrSubOrbit} ${fmsdrChoppDir} ${sensorId}"                	        + "\\\n" +
	"  ${nOrbits2Process} ${version}\n" +
	"fi\n\n" );

       private String ffCollocTaskString		    
    	= new String(
    	"#--------------------------------------------------------------------------------\n" 	+
    	"#      step: Collocate FMSDRs with the VIIRS-based forest fraction (for vipp)\n"      	+
    	"#--------------------------------------------------------------------------------\n" 	+
    	"if [[ \"${step_ffColloc}\" -eq 1 ]] ; then\n" +
    	"  ffColloc ${fmsdrDir} \"${extResol}\" ${fmsdr4ffCollocList} ${ffCollocDir}"    + "\\\n" + 
    	"  ${ffFile} ${ffLatLonFile} ${logFile} ${ffCollocControlFile}"     	            + "\\\n" +
    	"  ${ffCollocSrc} ${makeOrNot} ${binPath} ${processMode} ${orbitInfo}"           + "\\\n" +
    	"  ${retrOnOrbitOrSubOrbit} ${fmsdrChoppDir} ${sensorId}"                        + "\\\n" +
    	"  ${nOrbits2Process} ${version}\n" +
    	"fi\n\n" );
	...
	"  vipp ${edrList} ${edrDir} ${prepSweClimoDir} ${prepSweClimo4VippList}"               + "\\\n" +
	"  ${sweClimoUse} ${ffCollocDir} ${ffColloc4VippList} ${ffUse}"                         + "\\\n" +
        "  ${depDir}  ${logFile} ${nOrbits2Process} ${nProfs2Retr}" 	                        + "\\\n" + 
	"  ${sensorId} ${processMode} ${orbitInfo} \"${extResol}\" ${vippControlFile}" 	      	+ "\\\n" +
	"  ${vippSrc} ${binPath} ${siceEmissCatalogFile} ${snowEmissCatalogFile}\n" +
	"fi\n\n" );
    
    private String sfrTaskString		    
    	= new String(
	"#--------------------------------------------------------------------------------\n" 	+
	"#      step: To generate sfr products\n" 	                                        +
	"#--------------------------------------------------------------------------------\n" 	+
	"if [[ \"${step_sfr}\" -eq 1 ]] ; then\n" +
	" sfr ${satId} ${sensor1} ${fmsdrDir} \"${extResol}\" ${fmsdr4SfrList} ${sfrDir} ${sfrDataPath}"   + "\\\n" +
   "     ${logFile} ${sfrSrc} ${makeOrNot} ${binPath}"                                                + "\\\n" +
   "     ${processMode} ${orbitInfo} ${retrOnOrbitOrSubOrbit} ${fmsdrChoppDir}"                       + "\\\n" +
   "     ${nOrbits2Process} ${sfrControlFile} ${nwpSfrGridPath} ${gridNwpSfrList}"                    + "\\\n" +
   "     ${nProfs2Retr} ${sfr2depSrc} ${sfr2depControlFile} ${sfrList} ${depDir} ${depList}\n"        + 
   "fi\n\n" );
	...
	"  mirs2nc ${edrDir} ${depDir} ${ncDir} ${binPath} ${satId} ${rdrSensor1List} ${rdrType} ${HDF5BIN} ${production_site} ${production_environment}\n"                          +
	"fi\n\n" );
	...
	"  \"${email}\" \"${website}\" ${controlDataPath} ${satId} ${date} ${binPath}" + "\n\n" +
	...
	"  if [[ \"${satId}\" == \"f16\" || \"${satId}\" == \"f17\" || \"${satId}\" == \"f18\" || \"${satId}\" == \"f19\" || \"${satId}\" == \"gpm\" || \"${satId}\" == \"npp\" || \"${satId}\" == \"n20\" || ${satId} == \"n21\" || ${satId} == \"metopSGA1\" ]] ; then\n" 	+
	...
	"  ${logPath} ${prefixFMAccuracy} ${determineBiasSrc} " 		    + "\\\n" +
    ...
    private String uriString = new String("http://star.nesdis.noaa.gov/mirs");
    
    /**
     * MIRS web site URL Label
     */
    private JLabel uriLabel = new JLabel("<html><u>star.nesdis.noaa.gov/mirs</u></html>");
	...
	task2String.put("ims4nwp", "IMS Collocation for NWP");
	...
	task2String.put("ims4retr", "IMS Collocation for 1dvar");
	...
	task2String.put("prepSweClimo", "Prepare SWE Climatology Files");
	task2String.put("ffColloc", "Prepare Collocated FF Files");
	task2String.put("vipp", "Generate Derived Products");
	task2String.put("sfr", "SFR");
	...
	string2Task.put("IMS Collocation for NWP", "ims4nwp");
	...
	string2Task.put("IMS Collocation for 1dvar", "ims4retr");
	...
	string2Task.put("Prepare SWE Climatology Files", "prepSweClimo");
	string2Task.put("Prepare Collocated FF Files", "ffColloc");
	string2Task.put("Generate Derived Products", "vipp");
	string2Task.put("SFR", "sfr");
	...
	keys.add("imsAnalysisPath");
	keys.add("nwpSfrGridPath");
	...
	keys.add("SweClimoMeanFile");
	keys.add("SweClimoStdevFile");
	keys.add("ffFile");
	keys.add("ffLatLonFile");
	keys.add("sfrDataPath");
   ...
   keys.add("TBbias_NNModelFile");
   keys.add("TPW_NNModelFile");
   keys.add("Tskin_NNModelFile");
	...
	keys.add("prepSweClimoPath");
	keys.add("ffCollocPath");
	keys.add("imsCollocPath");
	...
	keys.add("prepSweClimoControlFile");
	keys.add("ffCollocControlFile");
	keys.add("imsCollocControlFile");
	keys.add("choppControlFile");
	keys.add("mergeEdrControlFile");
	keys.add("vippControlFile");
	keys.add("sfrControlFile");
	keys.add("sfr2depControlFile");
	...
	keys.add("fmsdr4PrepSweList");
	keys.add("fmsdr4ffCollocList");
	keys.add("fmsdr4imsCollocList"); //liusy+
	keys.add("imsColloc4nwpList");
	keys.add("imsColloc4retrList");
	keys.add("fmsdr4SfrList");
	keys.add("prepSweClimo4VippList");
	keys.add("ffColloc4VippList");
	keys.add("edrList");
   ...
   keys.add("sfr2depSrc");
	...
	keys.add("prepSweSrc");
	keys.add("ffCollocSrc");
	keys.add("imsCollocSrc");
	...
	keys.add("email");
	keys.add("website");
	keys.add("production_site");
	keys.add("production_environment");
	...
	// load all task=value default values
  	tasks.put("step_rdr2tdrSensor1", "1");
	tasks.put("step_rdr2tdrSensor2", "1");
	tasks.put("step_mergeNedt", "1");
	tasks.put("step_tdr2sdrSensor1", "1");
	tasks.put("step_tdr2sdrSensor2", "1");
	tasks.put("step_fm", "1");
	tasks.put("step_ims4nwp", "0");
	tasks.put("step_nwp", "0");
	tasks.put("step_fwd", "0");
	//tasks.put("step_bufr", "0");
	tasks.put("step_biasGen", "0");
	tasks.put("step_choppRadFiles", "0");
	tasks.put("step_ims4retr", "0");
	tasks.put("step_externalDataFromRegress", "1");
	tasks.put("step_fmsdr2edr", "1");
	tasks.put("step_mergeEdr", "0");
	tasks.put("step_prepSweClimo", "1");
	tasks.put("step_ffColloc", "1");
	tasks.put("step_vipp", "1");
	tasks.put("step_sfr", "1");
	...
	comments.put("step_ims4nwp" , "#IMS SFC TYPE COLLOCATION FOR NWP STEP");
	...
	comments.put("step_ims4retr" , "#IMS SFC TYPE COLLOCATION FOR 1DVAR STEP");
	...
	comments.put("step_prepSweClimo" , "#PREPARE AND GENERATE THE COLLOCATED SWE CLIMATOLOGY FILES FOR VIPP");
	comments.put("step_ffColloc" , "#FOREST FRACTION COLLOCATION FOR VIPP SWE");
	comments.put("step_vipp" , "#VERTICAL INTEGRATION AND POST PROCESSING");
	comments.put("step_sfr" , "#Produce Snow Fall Rate");
	...
	comments.put("sensorId" ,"#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:NPP/ATMS,7:AMSRE,8:FY3/MWRI,9:TMI,10:GMI,12:MADRAS,13:SAPHIR,14:MetopB,15:AMSR2,18:F17,19:F19,20:JPSS(N20)/ATMS,21:MetopC");
	...
	comments.put("fmType" , "#POES/NPP/N20:0(low),1(high); DMSP:0(UAS-low),1(LAS),2(ENV),3(IMG-high); TMI/AMSR2/GMI:-1(coarse),0(low),1(high)");
	...
	comments.put("sweClimoUse" , "#=1->To use SWE climatology in SWE retrieval (vipp step), 0->Do not use SWE climatology");
	comments.put("ffUse" , "#=1->To use forest fraction correction in SWE retrieval (vipp step), 0->Do not use forest fraction");
	comments.put("imsSfcUse" , "#=1->To use IMS surface type in nwp and/or retrieval steps, 0->Do not use IMS surface type");
	comments.put("ndayLagIms" , "#Number of days lag specified between processing date and valid date of IMS analysis (=0->same day, =-1->previous day)");
	...
	comments.put("rdrTYpe" , "#Raw RDR type, mainly for NPP and N20 ATMS(1:TDR; 2:SDR-proxy from MIT; 3:SDR; 4:SDR-remap),other sensors set as 0");
	...
	comments.put("production_site" , "#For use at NDE");
	comments.put("production_environment" , "#For use at NDE");
	...
	sensorChooser.add(moaString);
  	...
  	sensorChooser.add(mocString);
  	sensorChooser.add(metopSGA1String);
 	sensorChooser.add(f16String);
	sensorChooser.add(f17String);
 	sensorChooser.add(f18String);
 	sensorChooser.add(f19String);
 	sensorChooser.add(nppString);
 	sensorChooser.add(n20String);
 	sensorChooser.add(n21String);
	...
	if ( fileToProcess != null  &&  processMode.equals("0") )  {
	    ...
	    else if ( sensor.equals("metopC") && fileToProcess.indexOf(".M3.") == -1 )  {
		JOptionPane.showMessageDialog(new JFrame(),
    			"Error: Selected file is not MetOp-C file.\n(Example: NSS.AMAX.M3.D06305.S0203.E0347.B0017677.SV)",
    			"Wrong File Selected",
    			JOptionPane.ERROR_MESSAGE);
	    ...
	    else if ( sensor.equals("f19") && fileToProcess.indexOf(".SD.") == -1 )  {
		JOptionPane.showMessageDialog(new JFrame(),
    			"Error: Selected file is not F19 SSMI/S file.\n(Example: NPR.TDRN.SD.D10151.S0434.E0611.B0317071.NS)",
    			"Wrong File Selected",
    			JOptionPane.ERROR_MESSAGE);
	...
	cancelButton.setEnabled(false);
	  ...
	  else if ( sensorSelected.equals(mocString) ) {
	  	sensor="metopC";
	  	paths.remove("satId");
		paths.put("satId", sensor);
	  }
	  else if ( sensorSelected.equals(metopSGA1String) ) {
	  	sensor="metopSGA1";
	  	paths.remove("satId");
		paths.put("satId", sensor);
	  }
	  ...
	  else if ( sensorSelected.equals(f19String) ) {
	  	sensor="f19";
	  	paths.remove("satId");
		paths.put("satId", sensor);
	  }
	  ...
	  else if ( sensorSelected.equals(n21String) ) {
	  	sensor="n21";
	  	paths.remove("satId");
		paths.put("satId", sensor);
	  }
	  else if ( sensorSelected.equals(n20String) ) { //jchen+
	  	sensor="n20";                            //jchen+
	  	paths.remove("satId");                   //jchen+
		paths.put("satId", sensor);              //jchen+
	  }
...
//		File file = new File(configPath+configFile);
	    ...
	    else if ( sensorSelected.equals(n20String) )
	    {
		paths.remove(sensorIdKey);
		paths.put(sensorIdKey,"20"); 
		sensor="n20";
		paths.remove("satId");
		paths.put("satId", sensor);
		configFile=sensor + "_pcf.bash";
	...
	try {
		...
		else if ( taskName.equals(ims4nwpString) ) {
			taskBuffer.append(ims4nwpTaskString);
		}
		...
		else if ( taskName.equals(ims4retrString) ) {
			taskBuffer.append(ims4retrTaskString);
		}
		...
		else if ( taskName.equals(prepSweClimoString) ) {
			taskBuffer.append(prepSweClimoTaskString);
		}
		else if ( taskName.equals(ffCollocString) ) {
		        taskBuffer.append(ffCollocTaskString);
		}
		else if ( taskName.equals(vippString) ) {
			taskBuffer.append(vippTaskString);
		}
		else if ( taskName.equals(sfrString) ) {
			taskBuffer.append(sfrTaskString);
		}
	...
	try {	
	    ...
	    Iterator it = keys.iterator();
	      ...
	      else if (key.equals("Tskin_NNModelFile")) {
	    	out.println("\n#-------------------------------------------------------------------------------");
   ...
   /**
	...
	paths.put("nwpSfrGridPath", "${externalDataPath}/gridNWP_sfr");
	paths.put("imsAnalysisPath", "${externalDataPath}/ims_analys");
	...
	paths.put("extBkgAtmFile", "${staticDataPath}/CovBkgStats/atmBkg_ECMWF_bin.dat");
	...
	paths.put("SweClimoMeanFile", "${staticDataPath}/SWE_Climatology/swe_ssmis_climo_ease_NHSH.dat_ascii");
	paths.put("SweClimoStdevFile", "${staticDataPath}/SWE_Climatology/swe_ssmis_stdev_ease_NHSH.dat_ascii");
	paths.put("ffFile", "${staticDataPath}/ForestFraction/VIIRS_2014_GST_latlon_avg25km.dat");
	paths.put("ffLatLonFile", "${staticDataPath}/ForestFraction/latlon_avg25km.dat");
	paths.put("sfrDataPath", "${staticDataPath}/SFR/");
	...
	paths.put("TBbias_NNModelFile",  "${semiStaticDataPath}/NeuralNetwork_ModelFiles/TBbias_NNmodel_${satId}_${sensor1}.h5");
	paths.put("TPW_NNModelFile",     "${semiStaticDataPath}/NeuralNetwork_ModelFiles/TPW_NNmodel_${satId}_${sensor1}.h5");
	paths.put("Tskin_NNModelFile",   "${semiStaticDataPath}/NeuralNetwork_ModelFiles/Tskin_NNmodel_${satId}_${sensor1}.h5");
	...
	paths.put("sfrPath", "${testbedDataPath}/Outputs/sfr/${satId}_${sensor1}_${sensor2}");
	...
	paths.put("prepSweClimoPath", "${dynamicDataPath}/swe_climo/${satId}_${sensor1}_${sensor2}");
	paths.put("ffCollocPath", "${dynamicDataPath}/ff_colloc/${satId}_${sensor1}_${sensor2}");
	paths.put("imsCollocPath", "${dynamicDataPath}/ims_colloc/${satId}_${sensor1}_${sensor2}");
	...
	paths.put("prepSweClimoControlFile", "${controlDataPath}/${satId}_prepSweClimo");
	paths.put("ffCollocControlFile", "${controlDataPath}/${satId}_ffColloc");
	paths.put("imsCollocControlFile", "${controlDataPath}/${satId}_imsColloc");
	...
	paths.put("sfrControlFile", "${controlDataPath}/${satId}_Sfr");
	paths.put("sfr2depControlFile", "${controlDataPath}/${satId}_Sfr2dep");
	...
	paths.put("fmsdr4PrepSweList", "${inputDataPath}/${satId}_fmsdrFiles_4PrepSweClimo");
	paths.put("fmsdr4ffCollocList", "${inputDataPath}/${satId}_fmsdrFiles_4ffColloc");
	paths.put("fmsdr4SfrList", "${inputDataPath}/${satId}_fmsdrFiles_4Sfr");
	paths.put("prepSweClimo4VippList", "${inputDataPath}/${satId}_sweClimoFiles_4Vipp");
	paths.put("ffColloc4VippList", "${inputDataPath}/${satId}_ffCollocFiles_4Vipp");
	paths.put("fmsdr4imsCollocList", "${inputDataPath}/${satId}_fmsdrFiles_4imsColloc");
	paths.put("imsColloc4nwpList", "${inputDataPath}/${satId}_imsCollocFiles_4nwp");
	paths.put("imsColloc4retrList", "${inputDataPath}/${satId}_imsCollocFiles_4retr");
	...
	paths.put("sfrList", "${inputDataPath}/${satId}_sfrFiles");
	...
	paths.put("gridNwpSfrList", "${inputDataPath}/${satId}_NWPsfr");
	...
	paths.put("sfrSrc", "${rootPath}/src/testbed/sfr");
	paths.put("sfr2depSrc", "${rootPath}/src/testbed/sfr2dep");
	...
	paths.put("prepSweSrc", "${rootPath}/src/testbed/sweClimo");
	paths.put("ffCollocSrc", "${rootPath}/src/testbed/ffColloc");
	paths.put("imsCollocSrc", "${rootPath}/src/testbed/ims");
	paths.put("applyRegressAlgSrc", "${rootPath}/src/testbed/retrRegress");
	
	// Steps
	paths.put("step_rdr2tdrSensor1", "1");
	paths.put("step_rdr2tdrSensor2", "1");
	paths.put("step_mergeNedt", "1");
	paths.put("step_tdr2sdrSensor1", "1");
	paths.put("step_tdr2sdrSensor2", "1");
	paths.put("step_fm", "1");
	paths.put("step_ims4nwp", "0");
	paths.put("step_nwp", "0");
	paths.put("step_fwd", "0");
	paths.put("step_biasGen", "0");
	paths.put("step_choppRadFiles", "0");
	paths.put("step_ims4retr", "0");
	paths.put("step_externalDataFromRegress", "1");
	paths.put("step_fmsdr2edr", "1");
	paths.put("step_mergeEdr", "0");
	paths.put("step_prepSweClimo", "1");
	paths.put("step_ffColloc", "1");
	paths.put("step_vipp", "1");
	paths.put("step_sfr", "1");
	...
	paths.put("nwpGdasUse", "0");
	paths.put("nwpEcmwfUse", "0");
	paths.put("nwpGfsUse", "0");
	paths.put("extBkgAtmUse", "1");
	paths.put("sweClimoUse", "1");
	paths.put("ffUse", "0");
	paths.put("imsSfcUse", "0");
	paths.put("ndayLagIms", "-1");
	...
	paths.put("email", "Shu-Yan.Liu@noaa.gov");
	paths.put("website", "http://www.star.nesdis.noaa.gov/mirs/dataqualityv.php");
	paths.put("production_site", "NSOF");
	paths.put("production_environment", "OE");
   ...
   /**
	...
	outputArea.append("\nMetop-C config values are loaded.\n");
	...
	paths.put("sfrPath", "${testbedDataPath}/Outputs/sfr/${satId}_${sensor1}");
	...
	paths.put("prepSweClimoPath", "${dynamicDataPath}/swe_climo/${satId}_${sensor1}");
	paths.put("ffCollocPath", "${dynamicDataPath}/ff_colloc/${satId}_${sensor1}");
	paths.put("imsCollocPath", "${dynamicDataPath}/ims_colloc/${satId}_${sensor1}");
    ...
    /**
     * load F19 default config values into paths.
     */
    public void loadF19Config() {
   ...
   /** load metopSGA1 (EPS)
     ...
     * namely, load vector paths with key=value
     */
    public void loadmetopSGA1Config() {
	...
	// Satellite ID, Sensor ID and Default Date
	paths.put("satId", "metopSGA1");
	paths.put("sensor1", "mws");
	paths.put("sensor2", "dummy");
	paths.put("date", date);
	...
	outputArea.append("\nmetopSGA1 config values are loaded.\n");
   ...
   /**
	...
	paths.put("nwpAnalysPath", "${dynamicDataPath}/nwp_analys/${satId}_${sensor1}_${sensor2}");
	paths.put("fwdAnalysPath", "${dynamicDataPath}/fwd_analys/${satId}_${sensor1}_${sensor2}");
	paths.put("prepSweClimoPath", "${dynamicDataPath}/swe_climo/${satId}_${sensor1_${sensor2}}");
	paths.put("ffCollocPath", "${dynamicDataPath}/ff_colloc/${satId}_${sensor1}_${sensor2}");
	paths.put("imsCollocPath", "${dynamicDataPath}/ims_colloc/${satId}_${sensor1}");
	paths.put("regressRetrPath", "${dynamicDataPath}/regress_retr/${satId}_${sensor1}_${sensor2}");
   ...
   /**
	...
	else if ( sensor.equals("f16") || sensor.equals("f17") || sensor.equals("f18") || sensor.equals("f19") || sensor.equals("trmm") ) 
		rowNum=tasksKeysF16.length;
	else if ( sensor.equals("npp") )
		rowNum=tasksKeysNpp.length; 
	else if ( sensor.equals("n21") )
		rowNum=tasksKeysN20.length; 
	else if ( sensor.equals("n20") )       //jchen+
		rowNum=tasksKeysN20.length;    //jchen+
	else if ( sensor.equals("metopSGA1") )
		rowNum=tasksKeysmetopSGA1.length;
	...
	else if ( sensorId.equals("19") ) { sensorChooser.select(f19String);    sensor="f19";      }
	else if ( sensorId.equals("20") ) { sensorChooser.select(n20String);	sensor="n20";	   }
	else if ( sensorId.equals("21") ) { sensorChooser.select(mocString);	sensor="metopC";   }
	else if ( sensorId.equals("22") ) { sensorChooser.select(metopSGA1String);	sensor="metopSGA1";   }
	else if ( sensorId.equals("23") ) { sensorChooser.select(n21String);	sensor="n21";	   }
...
*/
    ...
    /**
     * to load Metop-C tasks ( the same as N18 )
     */
    private void tasks2Moc() {
     	tasks2N18();
    }
    ...
    /**
     * to load N20 tasks ( one more step of bufr than N18 
     Junye Chen
     Shuyan Liu updated
     */
    private void tasks2N20() {
       tasks2Npp();
    }
    
    /**
     * to load metopSGA1 tasks ( one more step of bufr than N18 
     */
    private void tasks2metopSGA1() {
       tasks2Npp();
    }
    ...
    /**
     * fwd task string change for Metop-C
     */
    private void fwdChopp2Moc() {
    	fwdChopp2N18();
    }
    ...
    /**
     * fwd task string change for F19
     */
    private void fwdChopp2F19() {
	fwdChopp2F16();
    }
    ...
    /**
     * fwd task string change for N20
     */
    private void fwdChopp2N20() {
    	fwdChopp2F16();
    }

    /**
     * fwd task string change for metopSGA1
     */
    private void fwdChopp2metopSGA1() {
    	fwdChopp2F16();
    }
