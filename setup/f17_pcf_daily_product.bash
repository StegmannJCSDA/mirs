...
sfrPath=${testbedDataPath}/Outputs/sfr/${satId}_${sensor1}
...
prepSweClimoPath=${dynamicDataPath}/swe_climo/${satId}_${sensor1}
ffCollocPath=${dynamicDataPath}/ff_colloc/${satId}_${sensor1}
imsCollocPath=${dynamicDataPath}/ims_colloc/${satId}_${sensor1}
...
sensorId=18	#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:NPP/ATMS,7:AMSRE,8:FY3/MWRI,9:TMI,10:GMI,12:MADRAS,13:SAPHIR,14:MetopB,15:AMSR2,18:F17,19:F19,20:JPSS(N20)/ATMS,21:MetopC
...
fmType=2	#POES/NPP/N20:0(low),1(high); DMSP:0(UAS-low),1(LAS),2(ENV),3(IMG-high); TMI/AMSR2/GMI:-1(coarse),0(low),1(high)
...
nScanLineSensor1Skip=-99	#Number of sensor 1 scan lines to skip upfront (to accomodate geolocation issues) 
nScanLineSensor2Skip=-99	#Number of sensor 2 scan lines to skip upfront (to accomodate geolocation issues) 
