...
step_ims4retr=1	               #IMS SFC TYPE COLLOCATION FOR 1DVAR STEP
...
sensorId=10	#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:NPP/ATMS,7:AMSRE,8:FY3/MWRI,9:TMI,10:GMI,12:MADRAS,13:SAPHIR,14:MetopB,15:AMSR2,18:F17,19:F19,20:JPSS(N20)/ATMS,21:MetopC
...
imsSfcUse=1	#=1->To use IMS surface type in nwp and/or retrieval steps, 0->Do not use IMS surface type
...
dayUsed4Bias=2010_08_25	#Extension used to determine which bias to use in the ec process.
dayUsed4Alg=2010_08_25	#Extension used to determine which algorithms to use in the externDataFromRegress step
