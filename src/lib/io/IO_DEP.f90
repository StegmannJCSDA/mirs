...
MODULE IO_DEP
  ...
  TYPE   :: DEP_type
    ...
    !---Positioning Data
    REAL                                       :: Angle      !Satellite zenith angle
    ...
    REAL                                       :: Prob_SF    = DEFAULT_VALUE_REAL !Probability of falling snow (%)
    REAL                                       :: Prob_RF    = DEFAULT_VALUE_REAL !Probability of falling rain (%)
    !---QC info 
...
!===============================================================
  ...
  SUBROUTINE WriteDEP(iu,DEP)
    ...
    ENDIF
    !---For the updated SFR product (2019-03-05)
    IF (DEP%AlgSN .ge. 4150) THEN
       WRITE(iu) DEP%Prob_SF,DEP%Prob_RF
    ENDIF
    RETURN
...
!===============================================================
  ...
  SUBROUTINE ReadDEP(iu,DEP,ierr)
    ...
    ENDIF
    !---SFR new variables (2019-03-11)
    IF (DEP%AlgSN .ge. 4150) THEN
       READ(iu,err=20) DEP%Prob_SF,DEP%Prob_RF
    ELSE
