...
MODULE Consts
  ...
  REAL,                    PARAMETER :: epsilonHydro       = 0.00002       !   -       | Epsilon for CLW,Grauple, and rain profile minimum|
  ...
  INTEGER,                 PARAMETER :: SENSOR_ID_F19      = 19            !   -       | Sensor ID for DMSP-F19 |
  INTEGER,                 PARAMETER :: SENSOR_ID_N20      = 20            !   -       | Sensor ID for JPSS1 N20 ATMS|
  INTEGER,                 PARAMETER :: SENSOR_ID_METOPC   = 21            !   -       | Sensor ID for Metop-C  | 
  INTEGER,                 PARAMETER :: SENSOR_ID_metopSGA1= 22            !   -       | Sensor ID for MetopSGA1 |
  INTEGER,                 PARAMETER :: SENSOR_ID_N21      = 23            !   -       | Sensor ID for JPSS2 N21 ATMS|
  ...
  CHARACTER(LEN=3),        PARAMETER :: SATID_F19          = 'f19'         !   -       / String ID for F19      /
  CHARACTER(LEN=3),        PARAMETER :: SATID_N20          = 'n20'         !   -       / String ID for JPSS-1 N20/
  CHARACTER(LEN=6),        PARAMETER :: SATID_METOPC       = 'metopC'      !   -       / String ID for METOPC   /
  CHARACTER(LEN=9),        PARAMETER :: SATID_metopSGA1    = 'metopSGA1'   !   -       / String ID for METOPSGA1 /
  CHARACTER(LEN=3),        PARAMETER :: SATID_N21          = 'n21'         !   -       / String ID for JPSS-2 N21/
  ...
  INTEGER,                 PARAMETER :: NTYP_CRTM          = 24            !   -       | No. of CRTM types
  INTEGER,DIMENSION(NTYP_CRTM),PARAMETER :: MAP_CRTM_2_TYP = (/0,3,1,2,2,2,2,2,2,2,2,2,2,2,&
