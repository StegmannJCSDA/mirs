!$Id: CntrlParams.f90 3709 2016-02-02 16:19:09Z chrisg $
!-----------------------------------------------------------------------------------------------
! Name:         CntrlParams
! 
! Type:         F90 module
...
MODULE CntrlParams
  ...
  TYPE :: CntrlConfig_type
    ...
    !--IMS sfc type collocation File
    CHARACTER(LEN=nLEN)                   :: imsCollocFile      !External IMS collocation file
    INTEGER                               :: useImsSfc          !Flag to use the IMS collocation file
    !---TBbias_NN
    CHARACTER(LEN=nLEN)                   :: TBbias_NNModelFile !TBbias_NN Model File
    CHARACTER(LEN=nLEN)                   :: TPW_NNModelFile    !TPW_NN Model File
    CHARACTER(LEN=nLEN)                   :: Tskin_NNModelFile  !Tskin_NN Model File
