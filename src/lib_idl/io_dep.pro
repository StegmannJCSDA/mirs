...
;    AlgVersion = 0L
    ...
    if ( DepIsNotDefined or NprfBiggerDeclaredSize) then begin
      ...
      ;---Probability of snowfall and rainfall
 		Prob_SF:fltarr(nPrf),			         $ ;Probability of Snow Fall 
 		Prob_RF:fltarr(nPrf) 			         $ ;Probability of Rainfall
	}
   ...
   IF ( AlgSN ge 4150) THEN BEGIN
      READU, iu, Prob_SF, Prob_RF
	   Dep.Prob_SF(i) 	   = PROB_SF
	   Dep.Prob_RF(i) 	   = PROB_RF
   ENDIf
