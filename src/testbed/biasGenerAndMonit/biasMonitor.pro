...
if ( satId eq 'gpm' ) then begin
    NPOS = 20
    if fmType eq -1 then NPOS = 20
    if fmType eq  0 then NPOS = 80
    if fmType eq  1 then NPOS = 160
    NCHAN = 13
...
pngFilePrefix  = "mirs_adv_poes_"
if (satId eq 'gpm') then pngFilePrefix  = "mirs_adv_eos_"
...
endif else if satId eq 'n20' then begin
  bias_files = FILE_SEARCH(bias_dir,'biasCorrec_'+satId+'_d????????_t???????_e???????_b?????.dat'+nwpStr, COUNT=nfiles_bias)
endif else if satId eq 'n21' then begin
  bias_files = FILE_SEARCH(bias_dir,'biasCorrec_'+satId+'_d????????_t???????_e???????_b?????.dat'+nwpStr, COUNT=nfiles_bias)
endif else begin
...
if nfiles_bias eq 0 then begin
  print, 'Warning: No biasCorrec_* file under ' + bias_dir + ', exit biasMonitor.pro.'
  exit
endif
...
; Channel Information
;*************************************************************** 
if satId eq 'n18' or satId eq 'metopA' or satId eq 'n19' or satId eq 'metopB' or satId eq 'metopC' then $
...
if satId eq 'n20' then $
  chan_strs=['23V','31V','50H','51H','52H','53H','54H1','54H2','55H','57H1','57H2',  $
             '57H3','57H4','57H5','57H6','88V','165H','183H1','183H2','183H3','183H4','183H5']
if satId eq 'n21' then $
  chan_strs=['23V','31V','50H','51H','52H','53H','54H1','54H2','55H','57H1','57H2',  $
             '57H3','57H4','57H5','57H6','88V','165H','183H1','183H2','183H3','183H4','183H5']
if satId eq 'metopSGA1' then $
  chan_strs=['23H','31H','50H','52H','53H1','53H2','53H3','54H1','54H2','55H','57H1','57H2',$
              '57H3','57H4','57H5','57H6','89V','165H','183V1','183V2','183V3','183V4','183V5','229V']
if satId eq 'gpm' then $
  chan_strs=['11V','11H','19V','19H','24V','37V','37H','89V','89H','166V','166H',  $
             '183V1','183V2']
...
if (satId eq 'gpm') then tickIntervals = [8,8,20]
...
FOR ISIZE = 0, 2 DO BEGIN
  ...
  for ichan = 0, NCHAN-1 do begin
    if ( satId eq 'f16' or satId eq 'f17' or satId eq 'f18' or satId eq 'f19' ) and ichan ge 18 then CONTINUE
    chan = STRTRIM(STRING(ICHAN+1),2)

    png_file = figs_dir + '/' + pngFilePrefix + satId + nwpStr + '_biasmean_glb_tb_ch' + chan + size_str + '.png'
    ...
    png_file = figs_dir + '/' + pngFilePrefix + satId + nwpStr + '_biasslope_glb_tb_ch' + chan + size_str + '.png'
    ...
    png_file = figs_dir + '/' + pngFilePrefix + satId + nwpStr + '_biasintercept_glb_tb_ch' + chan + size_str +'.png'
    ...
    png_file = figs_dir + '/' + pngFilePrefix + satId + nwpStr + '_tbSimu_glb_tb_ch' + chan + size_str + '.png'
    ...
    png_file = figs_dir + '/' + pngFilePrefix + satId + nwpStr + '_tbMeas_glb_tb_ch' + chan + size_str + '.png'
...
for ichan = 0, NCHAN-1 do begin
  ...
  if isize eq 0 then begin
    png_file=figs_dir + '/' + pngFilePrefix + satId + nwpStr + '_stdv_glb_tb_ch' + chan + '_small.png'
  ...
  if isize eq 1 then begin
    png_file=figs_dir + '/' + pngFilePrefix + satId + nwpStr + '_stdv_glb_tb_ch' + chan + '.png'
    device, set_resolution=[650,500]
  ...
  if isize eq 2 then begin
    png_file=figs_dir + '/' + pngFilePrefix + satId + nwpStr + '_stdv_glb_tb_ch' + chan + '_big.png'
