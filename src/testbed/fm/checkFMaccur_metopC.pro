...
PRO checkFMaccur_metopC, QCcheckPath, satId, date, processMode

;----Set input filename
;QCcheckPath='../../../data/TestbedData/PerfsMonitoring/metopC_amsua_mhs/'
;satId='metopC'
;date='2012-11-25'
;processMode=1
...
if ( satId eq 'metopC' ) then satName='MetOp-C'
