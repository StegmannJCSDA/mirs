...
Program rdr2tdr_mhs
  ...
  INTEGER,      PARAMETER             :: mxScan = 30000, nWarmView =4, nchar=3072,n_b = 540
  ...
  CHARACTER(1), DIMENSION(2, n_b)      :: count_bb
  ...
  MHS: DO ifile=1,nFiles
     ...
     !---Open MHS RDR file
     iu_mhs=get_lun()
     OPEN(iu_mhs, FILE=rdrFilesMHS(ifile), FORM='UNFORMATTED', ACCESS='DIRECT', RECL=nchar,&
