 ...
 * Date: 03/11/2010 
 *
 * 05/10/2016 Junye Chen @ESSIC/UMD STAR/NESDIS/NOAA
 *            In subroutine rdr2tdr_npp_atms_TDR, ingnore QF1_ATMSSDRGEO flag
 *
 ***************************************************************************************************/
...
float freq_npp[nchan_atms] = { 23.800, 31.400, 50.300, 51.760, 52.800, 53.596, 54.400, 54.940, 55.500, 57.290,
      57.290, 57.290, 57.290, 57.290, 57.290, 88.200, 165.500, 183.310, 183.310, 183.310,183.310, 183.310 } ;

int polar_npp[nchan_atms] = { 2, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 3 };
