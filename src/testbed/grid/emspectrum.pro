...
if satId eq 'f16' or satId eq 'f17' or satId eq 'f18' or $
   satId eq 'f19' then prefix='mirs_adv_dmsp_'+satId+'_ssmis_glb_'
if satId eq 'npp' then prefix='mirs_adv_npoess_'+satId+'_atms_glb_'
if satId eq 'n20' then prefix='mirs_adv_jpss_'+satId+'_atms_glb_'
if satId eq 'n21' then prefix='mirs_adv_jpss_'+satId+'_atms_glb_'
if satId eq 'mtma' then prefix='mirs_adv_mt_'+satId+'_madras_glb_'
if satId eq 'metopSGA1' then prefix='mirs_adv_poes_'+satId+'_mws_glb_'

NSFC=4
NANGLE=3

NCHAN=20
if satId eq 'f16' or satId eq 'f17' or satId eq 'f18' or satId eq 'f19' then NCHAN=24
if satId eq 'mtma'then NCHAN=9
if satId eq 'npp' or satId eq 'n20' or satId eq 'n21' then NCHAN=22
if satId eq 'metopSGA1' then NCHAN=24

titleSat = strupcase(satId)
if satId eq 'npp' then titleSat = 'NPP/ATMS'
if satId eq 'n20' then titleSat = 'N20/ATMS'
if satId eq 'n21' then titleSat = 'N21/ATMS'
if satId eq 'metopSGA1' then titleSat = 'metopSGA1/MWS'
...
;n20(23v:31v:50h:51h:52h:53h:54h1:54h2:55h:57h1:57h2:57h3:57h4:57h5:57h6:88v:165h:183h1:183h2:183h3:183h4:183h5)
...
if satId eq 'metopSGA1' then begin
  FREQS = [ 23.800, 31.400, 50.300, 52.800, 53.246, 53.596, 53.948, 54.400, 54.940, 55.500, 57.290, $
      57.290, 57.290, 57.290, 57.290, 57.290, 89.000, 165.500, 183.310, 183.310, 183.310,183.310, 183.310, 229.000 ]
  XTickVs = [ 23, 50, 89, 165, 183 ]
endif
;---- F16 
...
if satId eq 'f19' then titles = ['Horizontal', 'Vertical']
...
if satId eq 'f19' then yrange = [ 0.3, 1.0]
...
for icend = 0, 1 do begin
  ...
  IF satId eq 'n18' or satId eq 'n19' or satId eq 'metopA' or satId eq 'metopB' or satId eq 'metopC' or satId eq 'npp' or satId eq 'n20' or satId eq 'n21' or satId eq 'metopSGA1' THEN BEGIN
