...
;     02/03/2020       Yong-Keun Lee    Add JPSS2/N211
;
;***********************************************************************************************
...
if satId eq Consts.STR_SATID_F19   then prefix='mirs_adv_dmsp_'  +satId+'_ssmis' + resolution
if satId eq Consts.STR_SATID_NPP   then prefix='mirs_adv_npoess_'+satId+'_atms'  + resolution
if satId eq Consts.STR_SATID_N20   then prefix='mirs_adv_jpss_'  +satId+'_atms'  + resolution
if satId eq Consts.STR_SATID_N21   then prefix='mirs_adv_jpss_'  +satId+'_atms'  + resolution
...
if satId eq Consts.STR_SATID_metopSGA1   then prefix='mirs_adv_poes_'+satId+'_mws'  + resolution
...
;liusy+
if satId eq Consts.STR_SATID_GPM   then begin
  if resolutionStr eq 'CR' then NFOV = 20  & fmType = -1
  if resolutionStr eq 'LR' then NFOV = 80  & fmType = 0
  if resolutionStr eq 'HR' then NFOV = 160 & fmType = 1
endif
;liusy.
...
if satId eq Consts.STR_SATID_N18 or satId eq Consts.STR_SATID_METOPA or $
   ...
   satId eq Consts.STR_SATID_METOPC or satId eq Consts.STR_SATID_N21 or $
   satId eq Consts.STR_SATID_metopSGA1 or                               $
   satId eq Consts.STR_SATID_NPP or satId eq Consts.STR_SATID_N20 then begin
...
if satId eq Consts.STR_SATID_N18 or satId eq Consts.STR_SATID_METOPA or $
   satId eq Consts.STR_SATID_N19 or satId eq Consts.STR_SATID_METOPB or $
   satId eq Consts.STR_SATID_N19 or satId eq Consts.STR_SATID_METOPC then begin
...
if satId eq Consts.STR_SATID_metopSGA1 then begin
  ...
  chan_ids  = ['23h','31h','50h','52h','53h1','53h2','53h3','54h1','54h2','55h','57h1','57h2',$
               '57h3','57h4','57h5','57h6','88v','165h','183v1','183v2','183v3','183v4','183v5','229v']
endif
...
for iprod = 0, nprod_chan - 1 do begin
  ...
  if prodId eq 'em' then begin
    ...
    if satId eq Consts.STR_SATID_metopSGA1 then begin
      mins_sea  = [0.45,0.45,0.50,0.50,0.50,0.50,0.50,0.50,0.50,0.50,0.50,0.50,$
                   0.50,0.50,0.50,0.50,0.60,0.60,0.65,0.65,0.65,0.65,0.65,0.65]
      maxs_sea  = [0.55,0.60,0.70,0.70,0.65,0.65,0.65,0.65,0.70,0.65,0.65,0.65,$
                   0.65,0.65,0.65,0.65,0.75,0.80,0.75,0.80,0.85,0.85,0.85,0.85]
      mins_lnd  = [0.65,0.65,0.65,0.65,0.65,0.65,0.65,0.65,0.65,0.65,0.65,0.65,$
                   0.65,0.65,0.65,0.65,0.60,0.60,0.65,0.65,0.65,0.65,0.65,0.65]
      maxs_lnd  = [1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,$
                   1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00]
      mins_all  = [0.45,0.45,0.50,0.50,0.50,0.50,0.50,0.50,0.50,0.50,0.50,0.50,$
                   0.50,0.50,0.50,0.50,0.60,0.60,0.65,0.65,0.65,0.65,0.65,0.65]
      maxs_all  = [1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,$
                   1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00]
      divs      = replicate(10,24)
  ...
  if prodId eq 'tbc' or prodId eq 'tbu' then begin
    ...
    if satId eq Consts.STR_SATID_metopSGA1 then begin
      mins_all = [140,140,170,170,200,200,200,200,210,200,200,180, $
                  180,180,180,200,150,150,220,220,220,200,200,200]
      maxs_all = [300,300,290,290,270,270,270,250,230,230,230,230, $
                  250,250,280,290,300,300,300,300,300,300,300,300]
      divs     = [8,8,6,6,5, 5,5,5,6,6,5, 7,10,7,9,5, 5,5,9,6,5,6,6,6]
    endif
