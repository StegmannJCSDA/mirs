...
;*******************************************************************************
;---- default to AMSU ( N19/N19/MetopA/MetopB/MetopC )
...
;  maxs_all = [1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00]
  mins_sea = replicate(-0.1,13)
  maxs_sea = replicate(0.1,13)
  mins_lnd = replicate(-0.1,13)
  maxs_lnd = replicate(0.1,13)
  mins_all = replicate(-0.1,13)
  maxs_all = replicate(0.1,13)
