...
NLAY  = 11
NCHAN = 20
if satId eq 'n18' or satId eq 'n19' or satId eq 'metopA' or satId eq 'metopB' or satId eq 'metopC' then NCHAN = 20
if satId eq 'f16'  then NCHAN = 24 
if satId eq 'f17'  then NCHAN = 24 
if satId eq 'f18'  then NCHAN = 24 
if satId eq 'f19'  then NCHAN = 24 
if satId eq 'trmm' then NCHAN = 9
if satId eq 'gpm'  then NCHAN = 13 ;liusy+
...
if satId eq 'gpm'  then titSat = 'GPM/GMI' ;liusy+
...
;liusy+ 
	if( satId eq 'gpm' ) then begin
	  minvals = [0.55,0.25,0.58,0.25,0.60,0.65,0.25,0.75,0.45,0.45,0.45,0.45,0.45]
...
;liusy+	
	if( satId eq 'gpm' ) then begin
	  chans   = ['11v','11h','19v','19h','24v','37v','37h','89v','89h','166v','166h','183v1','183v2']
	  minvals = [  125,   50,  150,   75,  175,  150,  100,  175,  125,   250,   265,    240,   240 ]
	  maxvals = [  300,  300,  315,  315,  315,  315,  315,  315,  300,   300,   295,    280,   280 ]
