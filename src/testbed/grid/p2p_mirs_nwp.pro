...
if ( fromNameList eq 1 ) then begin
  ...
  readf,iu,format='(a)', nedtExt        ;nedt extention ( mainly for NPP. ?JPSS )
...
if satId eq Consts.STR_SATID_F19    then rotate = 'mirs_adv_dmsp_'
...
if satId eq Consts.STR_SATID_N20    then rotate = 'mirs_adv_jpss_'
if satId eq Consts.STR_SATID_N21    then rotate = 'mirs_adv_jpss_'
...
if satId eq Consts.STR_SATID_F19    then NCHAN = 24L
if satId eq Consts.STR_SATID_NPP    then NCHAN = 22L
if satId eq Consts.STR_SATID_N20    then NCHAN = 22L
if satId eq Consts.STR_SATID_N21    then NCHAN = 22L
if satId eq Consts.STR_SATID_metopSGA1    then NCHAN = 24L
...
if satId eq Consts.STR_SATID_N20    then satTxt = 'N20/ATMS'
if satId eq Consts.STR_SATID_N21    then satTxt = 'N21/ATMS'
if satId eq Consts.STR_SATID_TRMM   then satTxt = 'TRMM/TMI'
if satId eq Consts.STR_SATID_GPM    then satTxt = 'GPM/GMI'
if satId eq Consts.STR_SATID_metopSGA1    then satTxt = 'metopSGA1/MWS'
...
if nwpData eq 2 then begin
    ...
    if satId eq Consts.STR_SATID_TRMM or $
       satId eq Consts.STR_SATID_F16 or $
       satId eq Consts.STR_SATID_F18 or $
       satId eq Consts.STR_SATID_F17 or $
       satId eq Consts.STR_SATID_F19 then prodIds_1D = [ 'tskin', 'tpw', 'clw', 'iwp', 'lwp', 'wspd', 'psfc' ]
...
if nwpData eq 3 then begin
    ...
    if satId eq Consts.STR_SATID_TRMM or $
       ...
       satId eq Consts.STR_SATID_F18 or $
       satId eq Consts.STR_SATID_F17 or $
       satId eq Consts.STR_SATID_F19 then prodIds_1D = [ 'tskin', 'tpw', 'rr', 'wspd', 'psfc' ]
...
for icend = 0, ncend-2 do begin ; loop icend starts
  ...
  for iprod = 0, nprod_chan - 1 do begin ; loop iprod starts
    ...
    if prodId eq 'em' then begin
     ...
     if ( satId eq Consts.STR_SATID_metopSGA1 ) then begin
        chanIds = ['23h','31h','50h','52h','53h1','53h2','53h3','54h1','54h2','55h','57h1','57h2','57h3','57h4','57h5','57h6','89v','165h','183v1','183v2','183v3','183v4','183v5','229v']

        minvals = [0.4,0.4,0.4,0.4,0.4,0.4,0.4, 0.4,0.4,0.4,0.4,0.4, 0.4,0.4,0.4,0.4,0.4,0.4,0.5,0.5,0.5,0.5,0.5,0.5]
        maxvals = [1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00]
      endif
...
IF ( PLOT_TB eq 1 ) THEN BEGIN
  ...
  if ( satId eq Consts.STR_SATID_F16 or satId eq Consts.STR_SATID_F18 or $
        satId eq Consts.STR_SATID_F17 or satId eq Consts.STR_SATID_F19 ) then begin
    NUM_BIN=30
...
; Will need to be updated with real data
  ...
  if ( satId eq Consts.STR_SATID_MTSA ) then begin
    NUM_BIN=26
    BIN_BOX=4*findgen(NUM_BIN+1)-52
    nadirScanpos=12
  endif
...
;liusy-        xrange=[1,26]
  ...
  if ( satId eq Consts.STR_SATID_N21 ) then begin
   ...
   if ( satId eq Consts.STR_SATID_metopSGA1 ) then begin
        channels_str = ['23v','31v','50h','52h','53h1','53h2','53h3','54h1','54h2','55h','57h1','57h2','57h3','57h4','57h5','57h6','89v','165h','183h1','183h2','183h3','183h4','183h5','229v']
        xrange=[1,95]
        xtitle='Scan Position'
  endif
