 ...
 !    -  12/20/2016        Junye   Chen   Added JPSS1 N20   
 !==============================================================================
...
Program interEdr
  ...
  if( ( strcmp(satId1,'n18')    .eq. 0 .or. &
        ...
        strcmp(satId1,'metopB') .eq. 0 .or. &
        strcmp(satId1,'metopC') .eq. 0 )    &
                 .and.                      &
      ( strcmp(satId2,'n18')    .eq. 0 .or. &
        strcmp(satId2,'n19')    .eq. 0 .or. &
        strcmp(satId2,'metopA') .eq. 0 .or. &
        strcmp(satId2,'metopB') .eq. 0 .or. &
        strcmp(satId2,'metopC') .eq. 0 )    ) then
  ...
  else if ( strcmp(pair,'f19_f18') .eq. 0 .or. strcmp(pair,'f18_f19') .eq. 0 ) then
    ...
    if( fmType .eq. 0 ) then
      ...
      STOP 'Error: Incorrect fmType for SSMIS ( F19 vs F18 )'
    endif
    ALLOCATE(fov1_sizes(1:NFOV))
    ALLOCATE(fov2_sizes(1:NFOV))
  ...
  else if ( strcmp(pair,'f19_f17') .eq. 0 .or. strcmp(pair,'f17_f19') .eq. 0 ) then
    ...
    if( fmType .eq. 0 ) then
      ...
      STOP 'Error: Incorrect fmType for SSMIS ( F19 vs F17 )'
    endif
    ALLOCATE(fov1_sizes(1:NFOV))
    ALLOCATE(fov2_sizes(1:NFOV))
   ...
   ! 1st poes, 2nd npp atms
             ...
             strcmp(pair,'metopB_npp') .eq. 0 .or. &
             strcmp(pair,'metopC_npp') .eq. 0 .or. &
             strcmp(pair,'n18_n20')    .eq. 0 .or. &
             strcmp(pair,'n19_n20')    .eq. 0 .or. &
             strcmp(pair,'metopA_n20') .eq. 0 .or. &
             strcmp(pair,'metopB_n20') .eq. 0 .or. &
             strcmp(pair,'metopC_n20') .eq. 0 .or. &
             strcmp(pair,'n18_n21')    .eq. 0 .or. &
             strcmp(pair,'n19_n21')    .eq. 0 .or. &
             strcmp(pair,'metopA_n21') .eq. 0 .or. &
             strcmp(pair,'metopB_n21') .eq. 0 .or. &
             strcmp(pair,'metopC_n21') .eq. 0 ) then
   ...
   ! 1st npp/atms, 2nd poes
             ...
             strcmp(pair,'npp_metopB') .eq. 0 .or. &
             strcmp(pair,'npp_metopC') .eq. 0 .or. &
             strcmp(pair,'n20_n18')    .eq. 0 .or. &
             strcmp(pair,'n20_n19')    .eq. 0 .or. &
             strcmp(pair,'n20_metopA') .eq. 0 .or. &
             strcmp(pair,'n20_metopB') .eq. 0 .or. &
             strcmp(pair,'n20_metopC') .eq. 0 .or. &
             strcmp(pair,'n21_n18')    .eq. 0 .or. &
             strcmp(pair,'n21_n19')    .eq. 0 .or. &
             strcmp(pair,'n21_metopA') .eq. 0 .or. &
             strcmp(pair,'n21_metopB') .eq. 0 .or. &
             strcmp(pair,'n21_metopC') .eq. 0 ) then
 ...
 !--- Read all EDRs of data set 2 and save them in BIG arrays
  ...
  !---- compute fov size of atms low resolution
  ...
  !---- compute fov size of atms high resolution
