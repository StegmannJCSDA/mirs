...
NominalNedts = [0.210,0.200,0.210,0.220,0.220,0.220,0.260,0.250,0.530,0.560,0.390,0.380,$    
                0.350,0.340,0.450,0.260,0.220,0.190,0.190,1.230,1.180,0.860,0.580,0.580]
;----Set input filename
...
for iday=0,nList-1 do begin
    if (satID eq 'n18' or satId eq 'n19' or satId eq 'metopA' or satId eq 'metopB' or satId eq 'metopC') then begin
