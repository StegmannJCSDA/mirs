...
;     2016-12-20  Junye Chen, add JPSS/N20
;
;
;*******************************************************************************
...
if satId eq 'n20' then satTitle='N20/ATMS'
if satId eq 'n21' then satTitle='N21/ATMS'
if satId eq 'metopSGA1' then satTitle='metopSGA1/MWS'
dummy=''
...
if satId eq 'f19' then prefix='mirs_adv_dmsp_'+satId+'_ssmis_'
if satId eq 'npp' then prefix='mirs_adv_npp_'+satId+'_atms_'
if satId eq 'n20' then prefix='mirs_adv_jpss_'+satId+'_atms_'
if satId eq 'n21' then prefix='mirs_adv_jpss_'+satId+'_atms_'
if satId eq 'metopSGA1' then prefix='mirs_adv_poes_'+satId+'_mws_'
...
IF (newfileFlag eq 1) THEN BEGIN
    IF (satId ne 'npp' and satId ne 'n20' and satId ne 'n21') THEN BEGIN
...
IF (newfileFlag eq 0) THEN BEGIN
    ...
    ENDIF
    IF (satId ne 'npp' and satId ne 'n20' and satId ne 'metopA' and satId ne 'n21') THEN BEGIN
...
IF (satId ne 'npp' and satId ne 'n20' and satId ne 'n21') THEN $
  timeSuffix='_D'+startDay_string+'_S'+startTime_string+'_D'+endDay_string+'_E'+endTime_string+'_c'+ctime+'.dat'
IF (satId eq 'npp' or satId eq 'n20' or satId eq 'n21') THEN $
