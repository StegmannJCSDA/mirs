...
if satid eq 'metopSGA1' then $
  NEDT_LIMIT = [0.9,0.9,1.2,0.75,0.75,0.75,0.75,0.75,0.75,0.75,0.75,1.2,$
                1.2,1.5,2.4,3.60,0.50,0.60,0.80,0.80,0.80,0.80,0.9,0.9]

nchan=20
if satid eq 'npp' then nchan=22
if satid eq 'n20' then nchan=22
if satid eq 'n21' then nchan=22
